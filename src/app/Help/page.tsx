        ...
        <div className="max-w-screen-2xl mx-auto">
            <div className='form text-center my-6 ' >
                ...
                <div className='flex justify-center'>
                    <input className='w-96 text-xs px-5 py-3 my-2' type="text" placeholder='What can we help you with?' /> 
                    <button className='relative right-10'>  
                        <svg className="pl-2 block top-3 right-[500px] text-gray-400" width="30" height="30" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className='flex'>
                        <div className='my-4 py-4'>
                            ...
                            <div>
                                ...
                                <span>Yes, we recommend asking your bank to enable international purchases on your card. You will be notified at checkout if international purchases need to be enabled.</span><br /><br />
                            ...
                            <div>
                                ...
                                <span>To see Apple Pay as an option in the Nike App or on Nike.com, you'll need to use a compatible Apple device running the latest OS, be signed in to your iCloud account and have a supported card in your Wallet. Additionally, you'll need to use Safari to use Apple Pay on Nike.com.</span><br /><br />
                            </div>
                            <div>
